...
External pull requests do not run through the issue triage state machine. Collaborator and maintainer pull requests remain part of the normal review workflow.
...
- **Resolve**: comment with the answer, close the child issue, then append a context pointer to the map's Decisions-so-far section.
