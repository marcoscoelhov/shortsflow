...
Definição atual de breakout: `10.000+ views` ou `10x current mature median`, o que for maior. Baseline atual: `506` views maduras. Alvo secundário: `600+` views maduras.
...
- [Converter aprendizado em uma próxima ação Kanban](tickets/006-converter-aprendizado-em-acao-kanban.md) — criado o card [Exigir objeto reconhecível no hook de automatic_topic](kanban://t_07364fb6), lane `shortsflow`, com testes direcionados como aceitação.
...
- [Converter aprendizado em uma próxima ação Kanban](tickets/006-converter-aprendizado-em-acao-kanban.md) ✅ fechado
