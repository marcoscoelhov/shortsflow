...
def test_microdrama_prompt_instructs_implicit_share_trigger() -> None:
    ...
    assert "Escreva o hook com 7 a 8 palavras no máximo" in MICRODRAMA_VIRAL_PROMPT_TEMPLATE
    assert "pelo menos duas palavras fortes" in MICRODRAMA_VIRAL_PROMPT_TEMPLATE
