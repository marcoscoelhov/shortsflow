...
class Settings(BaseSettings):
    ...
    llm_premium_review_model: str | None = "grok-4.5"
    ...
    airtable_page_size: int = 100
    airtable_timeout_sec: float = 30.0
    airtable_ready_status: str = "Novo"
    airtable_imported_status: str = "Imported"
    airtable_error_status: str = "Error"
    airtable_mark_imported: bool = True
    airtable_min_score: float = 9.0
    ...
    airtable_beat_fields: list[str] = ["Beat 1", "Beat 2", "Beat 3", "Beat 4", "Beat 5", "Beat 6"]
    airtable_payoff_field: str = "Payoff"
    airtable_closing_field: str = "Fechamento"
    airtable_hashtags_field: str = "Hashtags"
    airtable_imported_at_field: str | None = None
    airtable_import_error_field: str | None = None
    airtable_import_count_field: str | None = None
    ...
    def validate_vision_verifier_provider(cls, value: str) -> str:
        normalized = value.strip().lower()
        allowed = {"minimax_mmx", "gemini", "disabled"}
        if normalized not in allowed:
            raise ValueError("vision_verifier_provider must be one of: minimax_mmx, gemini, disabled")
        return normalized
